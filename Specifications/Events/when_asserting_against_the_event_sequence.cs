...
namespace Dolittle.Machine.Specifications.Events
{
    ...
    public class when_asserting_against_the_event_sequence : an_aggregate_root_with_uncommitted_events
    {
        static object an_event_in_first_position;
        static object another_event_in_last_position;
